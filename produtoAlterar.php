...
//3. Prepara o SQL 
$sql= "update produto
set nome= '$nome', unidadeDeMedida='$unidadeDeMedida' where id = $id";
...
// 6. Busca usuário selecionado pelo "produtoCategoriaListar.php"
...
<h1>Alteração de Produto</h1>
 ...
 <div class="mb-3">
    ...
    <input type="text" class="form-control" id="unidade" name="unidadeDeMedida"  
    value= "<?= $linha['unidadeDeMedida']?>">
 </div>
